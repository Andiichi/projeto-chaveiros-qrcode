...
- **Frontend**: HTML, CSS, Bootstrap, JS, Jinja2
...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/seu-usuario/projeto-chaveiros-qrcode.git
   cd projeto-chaveiros-qrcode
   ```
